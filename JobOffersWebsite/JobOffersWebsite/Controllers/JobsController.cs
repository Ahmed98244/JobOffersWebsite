...
namespace Job_Offers_Website.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,JobContent,JobTime,CategoryId")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,JobContent,JobTime,CategoryId")] Job job)
        {
            if (ModelState.IsValid)
            {
